    ...
    <div className='w-full'>
      <Listbox value={jobTitle} onChange={setJobTitle}>
        <div className='relative'>
          <Listbox.Button className='relative w-full cursor-default rounded bg-white py-2.5 pl-3 pr-10 text-left focus:outline-none border border-black focus:border-black focus:ring-1 focus:ring-black sm:text-sm'>
