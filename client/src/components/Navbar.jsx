  ...
  return (
    <>
      <div className="relative bg-[#f7fdfd] z-50">
        <nav className="container mx-auto flex items-center justify-between p-5 mt-[-60px]">
          <div>
            <Link to="/">
              <img
                src={Logo_main}
          ...
          <ul className="hidden lg:flex gap-6 text-base">
            <li>
              <Link
                to="/"
                className="relative text-black font-bold py-2 px-4 transition duration-300 ease-in-out after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-[3px] after:bg-black after:transition-all after:duration-300 hover:after:w-full"
              >
                Find Job
              </Link>
            </li>
