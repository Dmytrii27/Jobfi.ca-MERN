        ...
        {isFetching ? (
          ...
          <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md'>
            <div className='w-full flex items-center justify-between'>
              ...
              <div className=''>
                <AiOutlineSafetyCertificate className='text-3xl text-black-500' />
              </div>
            </div>

            <div className='w-full flex flex-wrap md:flex-row gap-2 items-center justify-between my-10'>
              <div className='border-2 border-black w-40 h-16 rounded-lg flex flex-col items-center justify-center bg-white'>
                <span className='text-black text-sm'>Salary</span>
              ...
              <div className='border-2 border-black w-40 h-16 rounded-lg flex flex-col items-center justify-center bg-white'>
                <span className='text-black text-sm'>Job Type</span>
                <p className='text-lg font-semibold text-black'>
                  {job?.jobType}
                </p>
              </div>

              <div className='border-2 border-black w-40 h-16 px-6 rounded-lg flex flex-col items-center justify-center bg-white'>
                <span className='text-black text-sm'>No. of Applicants</span>
                <p className='text-lg font-semibold text-black'>
              ...
              <div className='border-2 border-black w-40 h-16 px-6 rounded-lg flex flex-col items-center justify-center bg-white'>
                <span className='text-black text-sm'>No. of Vacancies</span>
                <p className='text-lg font-semibold text-black'>
                  {job?.vacancies}
                </p>
              </div>
              ...
              <div className='border-2 border-black w-40 h-16 px-6 rounded-lg flex flex-col items-center justify-center bg-white'>
                <span className='text-black text-sm'>Yr. of Experience</span>
                <p className='text-lg font-semibold text-black'>
                  {job?.experience}
                </p>
              </div>
            ...
            <div className='w-full'>
              {user?._id === job?.company?._id ? (
                ...
                <JobApplicationForm jobId={job?._id} onClose={() => setShowForm(false)} />
              ) : (
                <CustomButton
                  title='Apply Now'
