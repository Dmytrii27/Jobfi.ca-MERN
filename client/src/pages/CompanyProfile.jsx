                  ...
                  >
                    ...
                    <div className='mt-4'>
                      {isLoading ? (
                        ...
                        <CustomButton
                          type='submit'
                          containerStyles='inline-flex justify-center rounded-md border border-transparent bg-black px-8 py-2 text-sm font-medium text-white hover:bg-gray-800 focus:outline-none'
                          title={"Submit"}
                        />
                      )}
                    </div>
      ...
      <div className=''>
          ...
          {user?.user?.accountType === undefined && info?._id === user?._id && (
            <div className='flex items-center justify-center py-5 md:py-0 gap-4'>
              <CustomButton
                ...
                iconRight={<FiEdit3 />}
                containerStyles={`py-1.5 px-3 md:px-5 focus:outline-none bg-black hover:bg-gray-800 text-white rounded text-sm md:text-base border border-black`}
              />
        ...
        <div className='w-full flex flex-col md:flex-row justify-start md:justify-between mt-4 md:mt-8 text-sm'>
          ...
          <div className='flex flex-col items-center mt-10 md:mt-0'>
            ...
            <p className='text-black '>Job Post</p>
          </div>
        </div>
      </div>
